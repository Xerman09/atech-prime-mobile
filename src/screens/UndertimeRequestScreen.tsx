    ...
    const fetchHistory = async () => {
      ...
      try {
        const url = Platform.OS === 'web' 
          ? 'http://localhost/atech_prime/backend/public/api/undertime-requests?scope=personal'
          : 'http://192.168.100.31/atech_prime/backend/public/api/undertime-requests?scope=personal';
        ...
        console.error('Failed to fetch Undertime History:', error);
      } finally {
        setIsLoading(false);
      }
    };
            ...
            <View key={item.id} style={styles.historyCard}>
              ...
              <View style={styles.dateContainer}>
                ...
                <View style={styles.dateBlock}>
                  ...
                  <Text style={styles.dateValue}>{formatTime(item.start_time)} - {formatTime(item.end_time)}</Text>
                </View>
              </View>
              ...
              {selectedRequest && (
                <>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>Undertime</Text>
                  </View>
                  <View style={styles.detailRow}>
                  ...
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>{formatTime(selectedRequest.start_time)} - {formatTime(selectedRequest.end_time)}</Text>
                  </View>
                  <View style={styles.detailRow}>
